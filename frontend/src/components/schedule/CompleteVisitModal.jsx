          ...
          <div>
            ...
            <div className="mt-3">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-hairline rounded-lg text-sm placeholder-ink-3 focus:outline-hidden focus:ring-2 focus:ring-indigo-500/20 focus:border-blue-400"
              />
            </div>
          </div>
        </div>
