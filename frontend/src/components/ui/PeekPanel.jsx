  ...
  return (
    <>
      ...
      <aside
        ...
        role="dialog"
        aria-modal="false"
        className="fixed inset-y-0 right-0 z-50 flex w-full max-w-[420px] flex-col border-l border-hairline-2 bg-panel shadow-glass-lg outline-hidden shell:inset-y-2 shell:right-2 shell:rounded-lg shell:border"
      >
