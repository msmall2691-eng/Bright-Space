...
export default function TweaksPanel() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 bg-panel border border-hairline rounded-xl shadow-lg p-4 w-72 text-sm">
      <div className="text-xs font-semibold text-ink-2 uppercase tracking-wider mb-4">Dev Tweaks</div>

      {/* Theme */}
      <div className="mb-4">
        <div className="flex items-center gap-2 text-xs font-medium text-ink-2 mb-2">
