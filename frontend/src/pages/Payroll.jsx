...
export default function Payroll() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl">
      ...
      {/* Tabs */}
      <div className="flex gap-1 bg-bg-2 p-1 rounded-lg w-fit mb-5">
        {[
              ...
              <div key={emp.employee_id} className="bg-panel border border-hairline rounded-xl p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xs text-ink-3 mt-0.5">ID: {emp.employee_id}</div>
                  </div>
                  {tab === 'timesheets'
                    ...
                    : <div className="text-right"><div className="font-bold text-ink">{emp.total_miles.toFixed(1)} mi</div><div className="text-green-400 font-semibold">${emp.reimbursement.toFixed(2)}</div></div>
                  }
                </div>
              </div>
            ))}
...
function Stat({ label, value, color = 'text-ink', small = false }) {
  return (
