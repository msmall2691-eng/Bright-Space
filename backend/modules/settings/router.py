...
class AutomationConfig(BaseModel):
    ...
    # jobs to Google). Part of the Sync Control Center master "auto-pilot"
    # switch: turning auto-pilot off also stops the background reconcile, so a
    # "Manual syncs only" state doesn't keep syncing via this tick. The tick
    # already re-reads this flag each run.
