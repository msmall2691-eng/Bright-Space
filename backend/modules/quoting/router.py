        ...
        if "@" not in to_email:
            ...
            try:
                ...
                pdf_bytes = QuotePDFService(
                    ...
                    quote_number=quote.quote_number, client_name=client.name, client_first_name=client.first_name,
                ...
                res = QuoteEmailService().send_quote_email(
                    to_email=to_email, client_name=client.name, client_first_name=client.first_name, quote_number=quote.quote_number,
...
def public_quote_pdf(token: str, download: bool = False, db: Session = Depends(get_db)):
    ...
    pdf_bytes = QuotePDFService(
        ...
        quote_number=quote.quote_number,
        client_name=client.name, client_first_name=client.first_name if client else "",
