...
def sync_property(db: Session, prop: Property, only_ical_id: int = None,
    ...
    # Connecteam removal (step 3): turnovers are no longer pushed to Connecteam
    # as draft shifts — the crew's native My Day reads turnover Jobs directly.
    # The response key stays (always 0) as an explicit retirement marker.
    connecteam_dispatched = 0
